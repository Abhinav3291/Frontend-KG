    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm sm:text-base">Welcome back to the KG Admin Portal.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-8">
        ...
        <div className="space-y-4">
          {[1, 2, 3, 4, 5].map((item) => (
            <div key={item} className="flex items-center p-3 sm:p-4 hover:bg-gray-50 rounded-xl transition-colors duration-150">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold mr-3 sm:mr-4 text-sm sm:text-base shrink-0">
              ...
              <span className="text-xs text-gray-400 shrink-0 hidden sm:block">2 hours ago</span>
            </div>
          ))}
        </div>
      </div>
