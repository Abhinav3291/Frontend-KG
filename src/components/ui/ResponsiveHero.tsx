...
export default function ResponsiveHero() {
  ...
  const slides: Slide[] = [
    {
      id: 1,
      image:
        "https://img.freepik.com/free-photo/man-getting-his-hair-cut-barber-shop4_23-2149186461.jpg?ga=GA1.1.1264861903.1717471952&semt=ais_hybrid&w=740",
    ...
    },
    {
      id: 2,
      image:
        "https://img.freepik.com/premium-photo/portrait-handsome-model-man-barber-shop-generative-by-ai_894067-13676.jpg?ga=GA1.1.1264861903.1717471952&semt=ais_hybrid&w=740",
    ...
    },
    {
      id: 3,
      image:
        "https://img.freepik.com/free-photo/man-barbershop-salon-doing-haircut-beard-trim_1303-20952.jpg?ga=GA1.1.1264861903.1717471952&semt=ais_hybrid&w=740",
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* HERO SLIDER */}
      <section id="home" className="pt-16 h-screen overflow-hidden relative">
          ...
          >
            ...
            <div className="relative z-20 max-w-xl">
              ...
              <a
                ...
                className="inline-block bg-amber-500 hover:bg-amber-600 text-black font-medium px-6 py-2 rounded-md transition"
              >
                {slide.btnText}
              </a>
            </div>
